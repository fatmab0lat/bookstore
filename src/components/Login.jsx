...
const handleLogin = async (values) => {
    ...
    return(
        <div className="h-screen w-screen bg-loginBack">
                ...
                <form className="w-screen h-screen flex flex-col items-center justify-center text-slate-100" onSubmit={handleSubmit}>
                    <div className="mb-4">
                        ...
                        />
                        {touched.email && errors.email && <div className="error text-red-600 text-xs">{errors.email}</div>}
                    </div>
                    <div className="mb-4">
                         <label className="block text-white text-sm font-medium mb-2">
                             Şifre
                         ...
                         <input
                           ...
                           value={values.password}
                            onChange={handleChange}
                          />
                          {touched.password && errors.password && <div className="error text-red-600 text-xs">{errors.password}</div>}
                    </div>
                    <button 
